            ...
            <Row>
                ...
                <Col sm={12} lg={6}>
                    <div className="mt-5">
                        ...
                        <ul>
                            <li className="fw-bold fs-5">CEO: Saif Ali Apurbo</li>
                            <li><i class="fas fa-phone-alt text-warning"></i>:  +01912163142</li>
                            <li></li>
                    ...
                    <div className="mt-5">
                        ...
                        <ul>
                            <li className="fs-5 fw-bold"><i class="fas fa-map-marker-alt text-warning"></i> Banglamotor,Dhaka</li>
                            <li><i class="fas fa-phone-alt text-warning"></i>: +2929236353</li>
                            <li></li>
                        </ul>
                    </div>
                </Col>
